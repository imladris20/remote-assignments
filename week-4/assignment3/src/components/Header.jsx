    ...
    <header className="top-header">
      ...
      {isFloatNavShowed
        ? <>
            ...
            <Link className="close-logo" href="#" style={{ display: 'block' }} onClick={actions.changeFloatNav} >
              <img className="close" alt="close" src="./assignment3/close.png" style={{ display: 'block' }}/>
            </Link>
          </>
        : <>
            ...
            <Link className="close-logo" href="#" style={{ display: 'none' }} onClick={actions.changeFloatNav}>
              <img className="close" alt="close" src="./assignment3/close.png" style={{ display: 'none' }} />
            </Link>
          </>
      }
      ...
      {isOriginNavShowed
        ? <Link className="main-logo h-items" onClick={actions.changeOriginNav} to="#">
            <img className="menu" alt="menu" src="./assignment3/menu.png" />
          </Link>
